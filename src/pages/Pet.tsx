...
const INITIAL_MISSIONS: Mission[] = [
  {
    id: 'reels',
    label: 'Publique 1 Reels ou Short hoje',
    hint: 'Consistência é o que mais alimenta o algoritmo',
    xp: 20,
    Icon: Video,
    done: false,
  },
  {
    id: 'comentarios',
    label: 'Comente em 3 posts da comunidade',
    hint: 'Interação gera reconhecimento entre os membros',
    xp: 10,
    Icon: MessageCircle,
    done: true,
  },
  {
    id: 'aula',
    label: 'Assista 1 aula da trilha Amentora',
    hint: 'Todo dia um pouco de técnica nova',
    xp: 15,
    Icon: BookOpen,
    done: false,
  },
  {
    id: 'curtidas',
    label: 'Deixe 5 curtidas em posts de outros criadores',
    hint: 'Comunidade forte cresce junto',
    xp: 8,
    Icon: Heart,
    done: false,
  },
...
const Pet: React.FC = () => {
  ...
  const mood = useMemo(() => {
    ...
    if (xp >= 40) return { label: 'Animada', color: '#E06B85' };
    return { label: 'Cochilando', color: '#5B4041' };
  }, [xp]);
  ...
  const handlePlay = () => {
    if (playing) return;
    setPlaying(true);
    gainXp(18, 'Brincou com a ' + petName);
    ...
    <div className="max-w-lg mx-auto px-4 pt-4 pb-28">
      ...
      <div className="mb-5">
        ...
        <p className="text-[13px] text-[#5B4041] mt-1">
          Cuide da {petName} todo dia e mantenha sua ofensiva viva.
        </p>
      </div>
      ...
      <div className="card-glass-liquid-pink rounded-3xl p-6 relative overflow-hidden">
        ...
        >
          ...
          >
            ...
            <div className="min-w-0">
              <p className="text-[12px] font-black text-[#1E1B11] leading-tight">Subiu de nível!</p>
        ...
        <div className="relative z-10 flex flex-col items-center text-center">
          ...
          <p className="text-[10px] font-bold text-[#5B4041] mt-2">toque na {petName} para fazer carinho</p>
          ...
          <div className="flex items-center gap-1.5 mt-3 bg-white/70 rounded-full px-3.5 py-1.5">
            ...
            <span className="text-[11px] font-bold text-[#5B4041]">de ofensiva</span>
          </div>
          ...
          <div className="w-full mt-5">
            ...
            <div className="flex items-center justify-between mt-1.5">
              ...
              <span className="text-[11px] font-bold text-[#5B4041]">
                faltam {100 - xp} XP p/ nível {level + 1}
              </span>
            </div>
          </div>
        </div>
      ...
      <div className="grid grid-cols-2 gap-3 mt-4">
        ...
        >
          ...
          <span className="text-[12px] font-black text-[#1E1B11]">Alimentar</span>
        ...
        >
          ...
          <span className="text-[12px] font-black text-white">Brincar</span>
      ...
      <div className="mt-7">
        <div className="flex items-center justify-between mb-3">
          <div>
            ...
            <h3 className="font-black tracking-tight text-[18px] text-[#1E1B11]">Missões do dia</h3>
          </div>
          ...
          {missions.map(m => (
            ...
            >
              ...
              <div className="flex-1 min-w-0">
                ...
                <p className="text-[10.5px] text-[#5B4041] mt-0.5 truncate">{m.hint}</p>
              </div>
      ...
      <div className="mt-6">
        {allDone ? (
          <div className="card-glass-liquid-lime rounded-2xl p-4 flex items-center gap-3">
            ...
            <div>
              <p className="text-[13px] font-black text-[#1E1B11]">Todas as missões concluídas!</p>
          ...
          <div className="viral-card rounded-2xl p-4 flex items-center gap-3">
            ...
            <div>
              <p className="text-[13px] font-black text-[#1E1B11]">Não perca a ofensiva!</p>
